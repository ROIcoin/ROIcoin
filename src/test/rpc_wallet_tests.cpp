...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CROIcoinAddress demoAddress = CROIcoinAddress(CTxDestination(demoPubkey.GetID()));
    Value retValue;
    ...
    CROIcoinAddress setaccountDemoAddress = CROIcoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(CROIcoinAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CROIcoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
}
