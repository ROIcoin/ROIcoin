...
{
    BOOST_CHECK(TestSplitHost("www.roi-coin.com", "www.roi-coin.com", -1));
    BOOST_CHECK(TestSplitHost("[www.roi-coin.com]", "www.roi-coin.com", -1));
    BOOST_CHECK(TestSplitHost("www.roi-coin.com:80", "www.roi-coin.com", 80));
    BOOST_CHECK(TestSplitHost("[www.roi-coin.com]:80", "www.roi-coin.com", 80));
    BOOST_CHECK(TestSplitHost("127.0.0.1", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("127.0.0.1:3377", "127.0.0.1", 3377));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]", "127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[127.0.0.1]:3377", "127.0.0.1", 3377));
    BOOST_CHECK(TestSplitHost("::ffff:127.0.0.1", "::ffff:127.0.0.1", -1));
    BOOST_CHECK(TestSplitHost("[::ffff:127.0.0.1]:3377", "::ffff:127.0.0.1", 3377));
    BOOST_CHECK(TestSplitHost("[::]:3377", "::", 3377));
    BOOST_CHECK(TestSplitHost("::3377", "::3377", -1));
    BOOST_CHECK(TestSplitHost(":3377", "", 3377));
    BOOST_CHECK(TestSplitHost("[]:3377", "", 3377));
...
BOOST_AUTO_TEST_CASE(netbase_lookupnumeric)
{
    ...
    BOOST_CHECK(TestParse("127.0.0.1:3377", "127.0.0.1:3377"));
    BOOST_CHECK(TestParse("::ffff:127.0.0.1", "127.0.0.1:65535"));
    BOOST_CHECK(TestParse("::", "[::]:65535"));
    BOOST_CHECK(TestParse("[::]:3377", "[::]:3377"));
    BOOST_CHECK(TestParse("[127.0.0.1]", "127.0.0.1:65535"));
