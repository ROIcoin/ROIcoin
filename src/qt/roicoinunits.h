...
#ifndef ROICOIN_QT_ROICOINUNITS_H
#define ROICOIN_QT_ROICOINUNITS_H
...
*/
class ROIcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit ROIcoinUnits(QObject *parent);

    /** ROIcoin units.
      @note Source: https://en.roicoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        ROI,
...
typedef ROIcoinUnits::Unit ROIcoinUnit;

#endif // ROICOIN_QT_ROICOINUNITS_H
