...
#ifndef ROICOIN_SCRIPT_STANDARD_H
#define ROICOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a CROIcoinAddress
 */
...
#endif // ROICOIN_SCRIPT_STANDARD_H
