...
public:
	...
	vSeeds.push_back(CDNSSeedData("seed6.roi-coin.com", "seed6.roi-coin.com"));  //India
...
public:
	...
	/*
	if(genesis.GetHash() != uint256S("001") ){
	...
	*/
	...
	vSeeds.push_back(CDNSSeedData("TestNet.roi-coin.com", "TestNet.roi-coin.com"));  //TestNet - Always Keep VPS Hot / Current.
        ...
        checkpointData = (Checkpoints::CCheckpointData) {
            boost::assign::map_list_of
            ( 0, uint256S("0x005566d40af96f9f09b5bd8b499f769e571ab11dea9390b4e81135f8770c63a4")),
