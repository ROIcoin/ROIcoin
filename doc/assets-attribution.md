The following is a list of assets used in the roicoin source and their proper attribution.
...
* ROIcoin Icon: (based on the original roicoin logo from Bitboy)
* Some icons are based on Stephan Hutchings Typicons
* License: MIT

### Assets Used
    src/qt/res/icons/about.png, src/qt/res/icons/about_qt.png,
    src/qt/res/icons/roicoin.icns, src/qt/res/icons/roicoin.ico,
    src/qt/res/icons/roicoin.png, src/qt/res/icons/clock*.png,
    ...
    src/qt/res/src/verify.svg, src/qt/res/src/roicoin.svg,
