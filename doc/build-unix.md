UNIX BUILD NOTES
====================
Some notes on how to build ROIcoin in Unix. 
...
memory available when compiling ROIcoin Core. With 512MB of memory or less
...
For Ubuntu 12.04 and later or Debian 7 and later libboost-all-dev has to be installed:
 ...
 db4.8 packages are available [here](https://launchpad.net/~roicoin/+archive/roicoin).
...
# Configure ROIcoin Core to use our own-built instance of BDB
cd $ROICOIN_ROOT
