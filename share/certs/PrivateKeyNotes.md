...
unlocked to sign the ROIcoin-Qt.app bundle.
...
allowing somebody to distribute a ROIcoin-Qt.app or roicoin-qt-setup.exe with a valid
...
that the roicoin-qt.exe file inside the installer had not been tampered with.
