...
###   This script attempts to download the signature file SHA256SUMS.asc from roi-coin.com
...
WORKINGDIR="/tmp/roicoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://roi-coin.com/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://roi-coin.com/bin/"
VERSIONPREFIX="roicoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'roicoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[roicoin-]<version>-[rc[0-9]] (example: roicoin-0.9.2-rc1)"
   echo "wget output:"
